...
def gen_crossings(ax, alpha_init, h, J, flip_seq, anc_flip, evo_flip, color1, color2):
    ...
    ax.annotate(f"{flip_anc_percent} \\%", xy=(0.0 + 0.05, -0.02), xycoords='axes fraction', ha='center', va='top', fontsize=14)
    ax.annotate(f"{flip_evo_percent} \\%", xy=(1.0 - 0.035, -0.02), xycoords='axes fraction', ha='center', va='top', fontsize=14)
