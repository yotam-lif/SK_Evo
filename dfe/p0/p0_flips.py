...
from misc.cmn import init_alpha, init_h, init_J, relax_sk, calc_DFE, curate_alpha_list, calc_rank, compute_fit_slow, calc_F_off
import scienceplots
...
plt.plot(time_points, bin_sizes, 'o-', markersize=3)
plt.ylabel('$P(0, t)$')
plt.xlabel('flips')
plt.grid(True)
plt.savefig(os.path.join(output_dir, 'P0_flips.png'), dpi=300)
plt.close()